...
Route::get('image/upload', ['as' => 'upload', function () {
...
Route::post('image/rating', function (Request $request) {
    $input = $request->all();
...
Route::post('image/add_tag', function (Request $request) {
    $input = $request->all();
...
Route::post('image/write_comment', function (Request $request) {
    $input = $request->all();
    $user_id = ($input['user_id']);
    $image_id = ($input['image_id']);
...
Route::get('image/detail', function (Request $request) {
    $input = $request->all();
    $display_desc = true;
    $click_by_user = true;
...
Route::get('change_background', function () {
